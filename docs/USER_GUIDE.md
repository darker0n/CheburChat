...
**Видит ли ВКонтакте мои сообщения?** При обычной работе Чебурчат заменяет отправляемый текст шифротекстом до отправки на сервер. Защита рассчитана на пассивное хранение и наблюдение со стороны сервера и сети. Но ввод и расшифровка происходят внутри интерфейса ВК: активный или скомпрометированный код страницы технически может прочитать нативное поле ввода или расшифрованный DOM. От такого кода, вредоносных расширений и программ на устройстве текущая бета не защищает.
